...
void Peon::Load()
{
	...
	mSeekBehaviour = mSteeringModule->AddBehavior<AI::SeekBehavior>();
	mWanderBehaviour = mSteeringModule->AddBehavior<AI::WanderBehavior>();
	mArriveBehaviour = mSteeringModule->AddBehavior<AI::ArriveBehaviour>();
	mPursuitBehaviour = mSteeringModule->AddBehavior<AI::PursuitBehaviour>();
	mEvadeBehaviour = mSteeringModule->AddBehavior<AI::EvadeBehaviour>();
